...
const DIAGRAMS = [
  ...
  },
  {
    ...
    alt: 'Animated organizational chart building from the top down with a traveling signal pulse along each connecting line: Incident Commander/Team Leader, Command Post, then expanding into Fire Suppression, Medical, and Search & Rescue teams.',
  ...
  },
  {
    ...
    alt: 'Animated radial diagram of the four phases of a crisis — Impact, Inventory, Rescue, and Recovery — with a traveling glowing pulse moving from the center to each phase in sequence.',
